...
int main(int argc, char *argv[])
{
    ...
    ///----------------------------------
    ///root element
    TypeElement*  root = new TypeElement("TestCase", true);
    ///create import line.
    ISerializeComponent* serialize = new ImportElement("UseCase", 1, 0);
    root->addImport(serialize);


    ///Child element1
    TypeElement*  buttonClick1 = new TypeElement("ButtonClick1");
    //Child element2
    TypeElement*  buttonClick2 = new TypeElement("ButtonClick2");
